...
local defaults = {
  profile = {
    ...
    AuraGroupsDurationFont = {
      ...
      vertical_justification = "TOP", -- can be: TOP, MIDDLE, BOTTOM
    ...
    AuraGroupsStackFont = {
      ...
      font_outlinemode = "OUTLINE",
      horizontal_justification = "RIGHT", -- can be: LEFT, CENTER, RIGHT
      vertical_justification = "BOTTOM", -- can be: TOP, MIDDLE, BOTTOM
      shadow_color = {0, 0, 0, 1},
      shadow_offset_x = 1,
      shadow_offset_y = -1,
    ...
    NameFont = {
      ...
      font_size = 12,
      font_outlinemode = "OUTLINE",
      horizontal_justification = "CENTER", -- can be: LEFT, CENTER, RIGHT
      vertical_justification = "TOP", -- can be: TOP, MIDDLE, BOTTOM
      shadow_color = {0, 0, 0, 1},
      shadow_offset_x = 1,
      shadow_offset_y = -1,
