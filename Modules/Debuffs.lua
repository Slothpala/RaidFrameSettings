        ...
        if unitAuraUpdateInfo == nil or unitAuraUpdateInfo.isFullUpdate then
            ...
            local function handle_harm_aura(aura)
                if not blacklist[aura.spellId] then
                    ...
                    if is_overriden ~= nil then
                        ...
                        auraCache[aura.auraInstanceID] = frame.debuffs[aura.auraInstanceID]
                    end
                end
            end
            debuffsChanged = true
            ...
            if unitAuraUpdateInfo.addedAuras ~= nil then
                for _, aura in next, unitAuraUpdateInfo.addedAuras do
                    if aura.isHarmful then
                        local is_set_by_default = frame.debuffs[aura.auraInstanceID]
            ...
            if unitAuraUpdateInfo.updatedAuraInstanceIDs ~= nil then
                for _, auraInstanceID  in next, unitAuraUpdateInfo.updatedAuraInstanceIDs do
                    local is_set_by_default = frame.debuffs[auraInstanceID]
            ...
            if unitAuraUpdateInfo.removedAuraInstanceIDs ~= nil then
                ...
                debuffsChanged = true -- they are already set to nil at this point so we have to always update on removed auras
            end
        end
